...
File Excel cuối cùng có `Optimized Data`, `Summary`, `Optimizer Input Debug`, `Logic`, và các sheet debug để kiểm tra tuần/offset/missing match.
"""
        )
...
st.write("Để trống nếu không có kho ưu tiên. `Value`: nhập 50 hoặc 0.5 đều được hiểu là 50%.")
